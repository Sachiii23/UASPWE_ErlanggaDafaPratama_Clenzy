    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            <div class="container mt-5">
                <form action="{{ route('cari.transaksi.dashboard') }}" method="post" style="display: flex; align-items: center;">
                    @csrf
                    ...
                    {{-- <div class="form-group ml-2">
                        <a href="{{ route('laporan.transaksi.download') }}" class="btn btn-danger" target="_blank">
                            Export PDF
                        </a>
                    </div> --}}
                    <div class="form-group ml-2">
                        <a href="{{ route('laporan.transaksi.view') }}" class="btn btn-info" target="_blank">
                            Export PDF
                        </a>
                    </div>
                </form>
