...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="{{ asset('landing/bootstrap.min.css') }}" rel="stylesheet">
...
<body>
    ...
    <header class="bg-blue py-5">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('admin/images/landing/header.png')}}" alt="" srcset="">
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="kelebihan bg-blue text-white">
        <div class="container p-5">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('admin/images/landing/alat.png')}}" alt="" srcset="">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="kelebihan bg-blue text-white">
        <div class="container p-5">
            <div class="row">
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('admin/images/landing/tipebaju.png')}}" alt=""
                        srcset="">
                </div>
                <div class="col-lg-6">
    ...
    <section class="kelebihan bg-blue text-white">
        <div class="container p-5">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid d-none d-lg-block" src="{{asset('admin/images/landing/pegawai.png')}}" alt=""
                        srcset="">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row flex-row flex-nowrap kategori">
                <div class="col-4 mb-2">
                    <div class="card">
                        <img src="{{asset('admin/images/landing/Baju.png')}}" class="card-img-top" alt="">
                ...
                <div class="col-4 mb-2">
                    <div class="card">
                        <img src="{{asset('admin/images/landing/Celana.png')}}" class="card-img-top" alt="">
                        <div class="card-body d-none d-lg-block">
                ...
                <div class="col-4 mb-2">
                    <div class="card">
                        <img src="{{asset('admin/images/landing/Jaket.png')}}" class="card-img-top" alt="">
                        <div class="card-body d-none d-lg-block">
                ...
                <div class="col-4 mb-2">
                    <div class="card">
                        <img src="{{asset('admin/images/landing/Selimut.png')}}" class="card-img-top" alt="">
                        <div class="card-body d-none d-lg-block">
