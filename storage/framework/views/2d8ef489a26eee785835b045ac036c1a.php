                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" action="<?php echo e(route('store.user')); ?>" method="post">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\applaundry\resources\views/register.blade.php ENDPATH**/ ?>