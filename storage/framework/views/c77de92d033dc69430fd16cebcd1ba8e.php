                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-validation">
                                <form class="form-valide" action="<?php echo e(route('store.transaksi')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('karyawan.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\applaundry\resources\views/karyawan/transaksi/create.blade.php ENDPATH**/ ?>