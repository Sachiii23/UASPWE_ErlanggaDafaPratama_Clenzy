                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                ...
                                <form class="mt-5 mb-5 login-input" action="<?php echo e(route('update.user', $data->id)); ?>" method="post">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('put'); ?>
                                <input type="hidden" name="id" value="<?php echo e($data->id); ?>">
                                <input type="hidden" name="password" value="<?php echo e($data->password); ?>">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Name" value="<?php echo e($data->name); ?>" name="name" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control" placeholder="Email" name="email" value="<?php echo e($data->email); ?>" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            <select class="form-control" name="status" id="val-skill">
                                                <option value="<?php echo e($data->status); ?>">-- Pilih Status --</option>                                        
...
<?php /**PATH C:\xampp\htdocs\applaundry\resources\views/admin/user/edit.blade.php ENDPATH**/ ?>