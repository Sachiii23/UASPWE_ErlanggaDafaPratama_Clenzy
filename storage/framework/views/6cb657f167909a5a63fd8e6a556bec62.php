...
<script src="<?php echo e(asset('admin/plugins/common/common.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('admin/./js/plugins-init/chartist.init.js')); ?>"></script>
        <script src="<?php echo e(asset('admin/cdn.jsdelivr.net/npm/chart.js')); ?>"></script>
        <script src="https://code.highcharts.com/highcharts.js"></script>
        <?php echo $__env->yieldContent('footer'); ?>
        <script src="<?php echo e(asset('admin/js/dashboard/dashboard-1.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\applaundry\resources\views/admin/layouts/footer.blade.php ENDPATH**/ ?>