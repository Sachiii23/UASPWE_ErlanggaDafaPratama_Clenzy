<script src="<?php echo e(asset('admin/plugins/common/common.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('admin/js/dashboard/dashboard-1.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\applaundry\resources\views/karyawan/layouts/footer.blade.php ENDPATH**/ ?>